...
private const val TAG = "NormalFactory"
...
class NotificationFactory {
    ...
    private fun registerNotification(type: NotificationType,notification: Notification) {
        Log.i(TAG, "registerNotification: type: $type")
        notificationRegistry[type] = notification
    }
